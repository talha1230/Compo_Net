// app/components/common/DarkModeToggle.tsx
import React from "react";
import { useTheme } from "src/context/ThemeContext";
import "./Toggle.css"; // Assuming you move your CSS to a separate file.
...
const DarkModeToggle: React.FC<DarkModeToggleProps> = ({ className }) => {
  ...
  <label className="toggle-label" htmlFor="toggle">
    <div className="cont-icon">
      <span
        style={{ "--width": 2, "--deg": 25, "--duration": 11 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 100, "--duration": 18 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 280, "--duration": 5 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 200, "--duration": 3 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 30, "--duration": 20 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 300, "--duration": 9 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 250, "--duration": 4 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 210, "--duration": 8 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 100, "--duration": 9 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 15, "--duration": 13 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 75, "--duration": 18 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 65, "--duration": 6 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 50, "--duration": 7 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 320, "--duration": 5 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 220, "--duration": 5 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 215, "--duration": 2 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 135, "--duration": 9 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 45, "--duration": 4 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 78, "--duration": 16 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 89, "--duration": 19 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 65, "--duration": 14 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 2, "--deg": 97, "--duration": 1 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 174, "--duration": 10 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <span
        style={{ "--width": 1, "--deg": 236, "--duration": 5 } as React.CSSProperties}
        className="sparkle"
      ></span>
      <svg
